 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.delivery.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.delivery'; // ios bundle id
const PACKAGE = 'com.delivery'; // android package name
const NAME = 'Delivery'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'Delivery'; // app scheme
